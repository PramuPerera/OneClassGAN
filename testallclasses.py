...
for classname in  [0]: #folders:
	...
	novellist = list(set(folders)-set([classname]))
 	print(novellist)
        ...
        trainerr = []
        valerr =[]
	os.system('python2 cvpriter.py --epochs 101  --batch_size 16  --ndf 8  --ngf 64  --istest 0 --expname grapesip64 --img_wd 61  --img_ht 61  --depth 3  --datapath ../mnist_png/mnist_png/  --noisevar 0.2  --lambda1 500 --seed 1000 --append 0  --dataset Mnist')
