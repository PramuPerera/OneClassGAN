...
def load_data(fnames, batch_size, is_reversed=False):
    img_in_list = []
    img_out_list = []
    shuffle(fnames)
...
train_data, val_data = load_data(inclasspaths, batch_size)
...
def set_network():
    ...
    netG = CEGenerator(in_channels=3)  # UnetGenerator(in_channels=3, num_downs=8) #
