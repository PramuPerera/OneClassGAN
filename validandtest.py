...
opt.epochs = ran[i]
opt.istest=0
print("AUC for criterion 1 (val): " + ocgantestdisjoint.main(opt))
opt.istest=1
print("AUC for criterion 1 (test): " + ocgantestdisjoint.main(opt))
...
opt.epochs = ran[i]
opt.istest=0
print("AUC for criterion 2 (val): " + ocgantestdisjoint.main(opt))
opt.istest=1
print("AUC for criterion 2 (test): " + ocgantestdisjoint.main(opt))
...
opt.epochs = ran[3i]
opt.istest=0
print("AUC for criterion 3 (val): " + ocgantestdisjoint.main(opt))
opt.istest=1
print("AUC for criterion 3 (test): " + ocgantestdisjoint.main(opt))
...
opt.epochs = ran[i]
opt.istest=0
print("AUC for criterion 4 (val): " + ocgantestdisjoint.main(opt))
opt.istest=1
print("AUC for criterion 4 (test): " + ocgantestdisjoint.main(opt))
